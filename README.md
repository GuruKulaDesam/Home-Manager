...
Learning provides seven pages for CBSE students in Classes 6-12: Dashboard, Curriculum, Planner, Assignments, Assessments, Practice and Reports. The supplied household starts with separate Class 7 and Class 12 profiles. Each child has an independent subject list, mastery record, weekly study plan, school work, scheduled exams, completed results, question-practice log, error notebook and parent review. The Class 12 workflow records theory and practical, project or internal evidence separately; the middle-stage workflow combines outcomes, application questions, projects and school feedback.
