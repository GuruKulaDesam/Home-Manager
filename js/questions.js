(function () {
  ...
  const answers = {
    ...
    'local-data': ['Household records stay in this browser profile', 'Google and SMS imports become local review suggestions; Google access tokens exist only in memory and SMS backup files are parsed without upload. Local records can be removed by clearing site data, and localStorage is not encrypted.', 'settings/app', 'privacy'],
    ...
    limitations: ['This static app has explicit boundaries', 'It has no direct bank feeds, live location or professional advice. Calendar and Gmail use session-only Google browser authorization; phone SMS works through local backup import because a website cannot read the live Android inbox.', 'settings/app', 'boundary'],
