(function () {
  ...
  const sets = [
    ...
    { id: 'actions', label: 'Adding & updating', icon: 'square-pen', route: 'global/overview', items: [
      ...group('quick-add', 'Everyone',
        ...
        'Where should I record an expense?',
    ...
    { id: 'workflows', label: 'Everyday workflows', icon: 'workflow', route: 'global/overview', items: [
      ...
      ...group('learning', 'Student',
        'Where is the Peepal parent portal?',
        'Where do I enter the confirmed school timetable?',
        'How do I track attendance without inventing school data?',
        'Where does a student complete daily self-assessment?',
        'How do we record Student-Parent-Tutor actions?',
        'Where do clubs, sports and co-curricular growth belong?'),
  ...
  const answers = {
    ...
    start: ['Set up the family, then run the day', 'Begin in Settings with the household profile and people. Return to Today for the first task or event; enter spending and commitments inside their owning family section.', 'settings/household', 'settings'],
    'daily-settings': ['Changing work stays outside Settings', 'Tasks, events, shopping, section budgets, spending and follow-ups belong in the seven daily groups. Profiles, addresses, sync consent and other stable facts belong in Settings.', 'settings/household', 'settings'],
    ...
    'section-tabs': ['Expand a life area in the sidebar', 'Select a coloured sidebar group to expand its related pages beneath it. Each group contains no more than seven choices.', 'home/overview', 'direct'],
    ...
    settings: ['Settings holds stable household facts', 'Open Settings at the bottom of the sidebar. Its three focused pages cover household identity, people and roles, and app data, privacy and connections.', 'settings/household', 'settings'],
    ...
    'quick-add': ['Use Add for common non-financial capture', 'The header Add button opens seven common tasks, events and household records. Financial entries stay in their owning section. Close the drawer with Cancel, X or Escape.', 'global/overview', 'workflow'],
    ...
    money: ['Enter locally, report centrally', 'Record an expense, budget or commitment in the section that caused it: vehicle costs in Vehicles, health costs and cover in Health, groceries in Food, school fees in Learning, and home costs in Property. Money is a read-only consolidation hub.', 'home/finance', 'workflow'],
    ...
    'money-workflow': ['Money consolidates seven family areas', 'Budget, Cash flow, Spending, Commitments, Net worth and Reports summarise source-owned records. Open Source from a report to add or correct the vehicle, health, food, property, learning, family or community record.', 'home/finance', 'workflow'],
    learning: ['One Peepal and CBSE suite from Class 6 to 12', 'Dashboard opens the verified Peepal hub and parent portal. Curriculum includes outcomes and daily self-assessment; Planner owns home study, confirmed school timetable and school dates; Assignments and Assessments hold school work and marks; Practice holds questions and errors; Reports combines readiness, attendance, Tutor actions and co-curricular growth.', 'study/overview', 'workflow'],
    ...
    care: ['Use the care register that owns the action', 'Care has separate Health, Medicines, Appointments, Elder care, Emergency and Pets registers. Their due dates roll up to the Care overview and Today. Store only masked references.', 'home/care', 'workflow'],
    'student-role': ['Each child gets a separate Peepal and CBSE workspace', 'Select the child in Learning. Class 7 follows the Peepal secondary model with competency, language, self-assessment and school work; Class 12 uses the published PCM plus Computer Science subject group and adds board-pattern practice, projects and separate practical or internal marks. Reports never compare siblings.', 'study/overview', 'boundary'],
    ...
    'local-data': ['Household records stay in this browser profile', 'Google and SMS imports become local review suggestions; Google tokens remain on the configured connector and SMS backup files are parsed without upload. Local records can be removed by clearing site data, and localStorage is not encrypted.', 'settings/app', 'privacy'],
    ...
    limitations: ['This static app has explicit boundaries', 'It has no direct bank feeds, live location or professional advice. Calendar and Gmail processing require the configured secure OAuth connector; phone SMS works through local backup import because a website cannot read the live Android inbox.', 'settings/app', 'boundary'],
