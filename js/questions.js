(function () {
  ...
  const answers = {
    ...
    learning: ['One CBSE suite from Class 6 to 12', 'Choose the student, then use Curriculum for outcomes, Planner for study blocks, Assignments for homework, projects and practicals, Assessments for scheduled exams and marks, Practice for questions, errors and focus, and Reports for readiness and parent actions.', 'study/overview', 'workflow'],
    ...
    'student-role': ['Each child gets a separate CBSE workspace', 'Select the child in Learning. Class 7 uses competency, homework and school-assessment evidence; Class 12 adds board-pattern practice and separate practical or internal marks. Reports never compare siblings. Financial access controls require a server and are not provided by this static app.', 'study/overview', 'boundary'],
