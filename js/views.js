(function () {
  ...
  const groups = {
    ...
    learning: { label: 'Education', icon: 'graduation-cap', note: 'Study and development', route: 'study/overview', items: [
  ...
  function practiceAndTests() {
    ...
    const recall = HM.genius.teacherNotes(lesson).check;
