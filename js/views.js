(function () {
  ...
  const groups = {
    today: { label: 'Today', icon: 'sparkles', note: 'Your daily command centre', route: 'global/overview', items: [
      ['Today', 'sparkles', 'global/overview'], ['Home overview', 'layout-dashboard', 'home/overview'], ['Tasks', 'list-checks', 'home/tasks'], ['Calendar', 'calendar-days', 'home/calendar'], ['Life Registry', 'layout-grid', 'home/life']
    ]},
    family: { label: 'Family', icon: 'users-round', note: 'People, plans and continuity', route: 'home/family', items: [
      ['Members', 'users', 'home/family'], ['Family calendar', 'calendar-days', 'home/calendar'], ['Health', 'heart-pulse', 'home/life/health'], ['Documents & IDs', 'folders', 'home/life/documents'], ['Festivals & Functions', 'party-popper', 'home/life/festivals'], ['Travel & Pilgrimage', 'luggage', 'home/life/travel'], ['Nominees & Legacy', 'scroll-text', 'home/life/legacy'], ['Directory', 'contact-round', 'home/directory']
    ]},
    home: { label: 'Home', icon: 'house', note: 'Household operations', route: 'home/overview', items: [
      ['Overview', 'layout-dashboard', 'home/overview'], ['Tasks', 'list-checks', 'home/tasks'], ['Supplies & Meals', 'shopping-basket', 'home/inventory'], ['Property & Utilities', 'building-2', 'home/life/property'], ['Vehicles', 'car-front', 'home/life/vehicles'], ['Domestic Help', 'hand-helping', 'home/life/help'], ['Sustainability', 'leaf', 'home/life/sustainability'], ['Maintenance & Assets', 'wrench', 'home/assets'], ['Digital Household', 'cloud-cog', 'home/life/digital']
    ]},
    money: { label: 'Money', icon: 'indian-rupee', note: 'Finances and protection', route: 'home/finance', items: [
      ['Expenses', 'wallet-cards', 'home/finance'], ['Bills & Payments', 'receipt-indian-rupee', 'home/life/bills'], ['Insurance', 'shield-check', 'home/life/insurance'], ['Tax & Compliance', 'landmark', 'home/life/tax'], ['Subscriptions', 'repeat-2', 'home/life/subscriptions'], ['Assets', 'gem', 'home/assets']
    ]},
    care: { label: 'Care', icon: 'heart-handshake', note: 'Wellbeing and readiness', route: 'home/life/health', items: [
      ['Family Health', 'heart-pulse', 'home/life/health'], ['Emergency Readiness', 'siren', 'home/life/emergency'], ['Pets & Animals', 'paw-print', 'home/life/pets'], ['Meals & Nutrition', 'salad', 'home/inventory'], ['Family Wellbeing', 'accessibility', 'home/family'], ['Wisdom & Recognition', 'book-heart', 'home/wisdom']
    ]},
    ...
    community: { label: 'Community', icon: 'map-pinned', note: 'Local participation', route: 'community/overview', items: [
      ['Overview', 'map', 'community/overview'], ['News & Forum', 'newspaper', 'community/feed'], ['Events', 'calendar-heart', 'community/events'], ['Polls', 'chart-no-axes-column', 'community/polls'], ['Volunteer', 'hand-heart', 'community/volunteer'], ['Civic Tickets', 'ticket-check', 'community/tickets'], ['Services', 'life-buoy', 'community/directory'], ['Guides', 'book-marked', 'community/guides']
    ]}
  };
