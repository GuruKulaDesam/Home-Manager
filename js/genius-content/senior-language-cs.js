(function () {
  ...
  english('Poets and Pancakes',
    ...
    [['Pancake make-up and manufactured glamour','Gemini Studios used thick Pancake make-up under hot lights to manufacture flawless screen faces. Asokamitran turns the uncomfortable process into comedy, exposing the labour and rank hidden beneath cinematic glamour.','Screen glamour → harsh backstage work → satire of hierarchy.'],['The office boy’s resentment and Subbu','The office boy treats Subbu as the cause of his failed literary ambition, but his complaint reveals projection rather than proof. Subbu’s loyalty, practical creativity and generosity explain his position more convincingly than the charge of flattery.','Frustration → scapegoating → unreliable judgement; usefulness → trust.'],['Stephen Spender and the misread visitor','Stephen Spender’s speech fails because the Gemini audience lacks the cultural, political and linguistic context needed to understand him. The narrator recognises the visitor only years later, turning confusion into delayed understanding and institutional ignorance.','Guest speaks → audience is puzzled → later reading supplies the missing context.']],
